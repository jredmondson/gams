...
#ifndef CAPNP_INCLUDED_eb49ecd66d0fce06_
#define CAPNP_INCLUDED_eb49ecd66d0fce06_
...
CAPNP_DECLARE_SCHEMA(f0b2f2604ebcde67);
...
struct Int32MultiArray {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(f0b2f2604ebcde67, 0, 2)
    #if !CAPNP_LITE
...
inline  ::capnp::List< ::int32_t>::Reader Int32MultiArray::Reader::getData() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::int32_t>>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::int32_t>::Builder Int32MultiArray::Builder::getData() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::int32_t>>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void Int32MultiArray::Builder::setData( ::capnp::List< ::int32_t>::Reader value) {
...
inline  ::capnp::List< ::int32_t>::Builder Int32MultiArray::Builder::initData(unsigned int size) {
...
inline ::capnp::Orphan< ::capnp::List< ::int32_t>> Int32MultiArray::Builder::disownData() {
...
inline  ::gams::types::MultiArrayLayout::Reader Int32MultiArray::Reader::getLayout() const {
  return ::capnp::_::PointerHelpers< ::gams::types::MultiArrayLayout>::get(_reader.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline  ::gams::types::MultiArrayLayout::Builder Int32MultiArray::Builder::getLayout() {
  return ::capnp::_::PointerHelpers< ::gams::types::MultiArrayLayout>::get(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
#if !CAPNP_LITE
inline  ::gams::types::MultiArrayLayout::Pipeline Int32MultiArray::Pipeline::getLayout() {
  return  ::gams::types::MultiArrayLayout::Pipeline(_typeless.getPointerField(1));
}
#endif  // !CAPNP_LITE
inline void Int32MultiArray::Builder::setLayout( ::gams::types::MultiArrayLayout::Reader value) {
  ::capnp::_::PointerHelpers< ::gams::types::MultiArrayLayout>::set(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), value);
}
inline  ::gams::types::MultiArrayLayout::Builder Int32MultiArray::Builder::initLayout() {
...
inline ::capnp::Orphan< ::gams::types::MultiArrayLayout> Int32MultiArray::Builder::disownLayout() {
...
#endif  // CAPNP_INCLUDED_eb49ecd66d0fce06_
