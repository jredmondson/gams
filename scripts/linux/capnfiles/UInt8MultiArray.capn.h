...
#ifndef CAPNP_INCLUDED_ceb127f0fe2c7edf_
#define CAPNP_INCLUDED_ceb127f0fe2c7edf_
...
CAPNP_DECLARE_SCHEMA(f53b0eda5482c6f1);
...
struct UInt8MultiArray {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(f53b0eda5482c6f1, 0, 2)
    #if !CAPNP_LITE
...
inline  ::capnp::List< ::uint8_t>::Reader UInt8MultiArray::Reader::getData() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::uint8_t>>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::uint8_t>::Builder UInt8MultiArray::Builder::getData() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::uint8_t>>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void UInt8MultiArray::Builder::setData( ::capnp::List< ::uint8_t>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::uint8_t>>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline void UInt8MultiArray::Builder::setData(::kj::ArrayPtr<const  ::uint8_t> value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::uint8_t>>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List< ::uint8_t>::Builder UInt8MultiArray::Builder::initData(unsigned int size) {
...
inline ::capnp::Orphan< ::capnp::List< ::uint8_t>> UInt8MultiArray::Builder::disownData() {
...
inline  ::gams::types::MultiArrayLayout::Reader UInt8MultiArray::Reader::getLayout() const {
  return ::capnp::_::PointerHelpers< ::gams::types::MultiArrayLayout>::get(_reader.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline  ::gams::types::MultiArrayLayout::Builder UInt8MultiArray::Builder::getLayout() {
  return ::capnp::_::PointerHelpers< ::gams::types::MultiArrayLayout>::get(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
#if !CAPNP_LITE
inline  ::gams::types::MultiArrayLayout::Pipeline UInt8MultiArray::Pipeline::getLayout() {
  return  ::gams::types::MultiArrayLayout::Pipeline(_typeless.getPointerField(1));
}
#endif  // !CAPNP_LITE
inline void UInt8MultiArray::Builder::setLayout( ::gams::types::MultiArrayLayout::Reader value) {
  ::capnp::_::PointerHelpers< ::gams::types::MultiArrayLayout>::set(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), value);
}
inline  ::gams::types::MultiArrayLayout::Builder UInt8MultiArray::Builder::initLayout() {
...
inline ::capnp::Orphan< ::gams::types::MultiArrayLayout> UInt8MultiArray::Builder::disownLayout() {
...
#endif  // CAPNP_INCLUDED_ceb127f0fe2c7edf_
