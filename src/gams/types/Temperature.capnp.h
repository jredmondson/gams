...
#ifndef CAPNP_INCLUDED_cb80a4bd0f662534_
#define CAPNP_INCLUDED_cb80a4bd0f662534_
...
CAPNP_DECLARE_SCHEMA(af42dc93863fb604);
...
struct Temperature {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(af42dc93863fb604, 2, 1)
    #if !CAPNP_LITE
...
inline  ::gams::types::Header::Reader Temperature::Reader::getHeader() const {
  return ::capnp::_::PointerHelpers< ::gams::types::Header>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::gams::types::Header::Builder Temperature::Builder::getHeader() {
  return ::capnp::_::PointerHelpers< ::gams::types::Header>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
#if !CAPNP_LITE
inline  ::gams::types::Header::Pipeline Temperature::Pipeline::getHeader() {
  return  ::gams::types::Header::Pipeline(_typeless.getPointerField(0));
}
#endif  // !CAPNP_LITE
inline void Temperature::Builder::setHeader( ::gams::types::Header::Reader value) {
  ::capnp::_::PointerHelpers< ::gams::types::Header>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::gams::types::Header::Builder Temperature::Builder::initHeader() {
...
inline ::capnp::Orphan< ::gams::types::Header> Temperature::Builder::disownHeader() {
...
#endif  // CAPNP_INCLUDED_cb80a4bd0f662534_
