...
void parse_pose (geometry_msgs::Pose *pose, knowledge::KnowledgeBase * knowledge,
  std::string container_name);
  ...
  knowledge::KnowledgeBase * knowledge, std::string container_name)
{
  ...
  containers::Double angle_increment (
    container_name + ".angle_increment", *knowledge);
