  ...
  std::string container_name)
{
  ...
  // we've removed capnp support for the foreseeable future due to
  // portability issues on Windows and other platforms
  // note that kb is no longer called so this is an expensive no-op
}
