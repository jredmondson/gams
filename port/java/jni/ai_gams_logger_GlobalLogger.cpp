#include "ai_gams_logger_GlobalLogger.h"
#include "gams/loggers/GlobalLogger.h"

namespace logger = gams::loggers;

jlong JNICALL Java_ai_gams_logger_GlobalLogger_jni_1getCPtr
(JNIEnv *, jclass)
{
  return (jlong)logger::global_logger.get ();
}

void JNICALL Java_ai_gams_logger_GlobalLogger_jni_1setLevel
...
jint JNICALL Java_ai_gams_logger_GlobalLogger_jni_1getLevel
(JNIEnv *, jclass)
{
...
jstring JNICALL Java_ai_gams_logger_GlobalLogger_jni_1getTag
(JNIEnv * env, jclass)
{
...
void JNICALL Java_ai_gams_logger_GlobalLogger_jni_1setTag
...
void JNICALL Java_ai_gams_logger_GlobalLogger_jni_1addTerm
(JNIEnv *, jclass)
{
...
void JNICALL Java_ai_gams_logger_GlobalLogger_jni_1addSyslog
(JNIEnv *, jclass)
{
...
void JNICALL Java_ai_gams_logger_GlobalLogger_jni_1clear
(JNIEnv *, jclass)
{
...
void JNICALL Java_ai_gams_logger_GlobalLogger_jni_1addFile
...
void JNICALL Java_ai_gams_logger_GlobalLogger_jni_1log
...
void JNICALL Java_ai_gams_logger_GlobalLogger_jni_1setTimestampFormat
